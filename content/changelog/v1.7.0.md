...
- Fix #55 - Action._next not initialized to nullptr (esphomelib/#57) by @brandond
...
- Passing inverted to output should be valid, but does not work, use … (esphomedocs/#7) by @aequitas
